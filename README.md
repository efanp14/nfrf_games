...
| `CityNetwork.gd` | Sioux Falls test-network topology, Link data, Dijkstra routing, city metrics |
...
# Home and Work nodes are set by the map (no participant-facing names).
```
